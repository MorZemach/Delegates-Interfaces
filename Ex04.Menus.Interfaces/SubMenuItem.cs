namespace Ex04.Menus.Interfaces
{
    ...
    public class SubMenuItem : MenuItem
    {
        ...
        public SubMenuItem(string i_MenuItemName, SubMenuItem i_PreviousMenuItem = null) : base(i_MenuItemName, i_PreviousMenuItem)
        {
        ...
        public void AddItemToSubMenu(MenuItem i_ItemToAdd)
        {
            r_SubMenuItems.Add(i_ItemToAdd);
        }

        public void RemoveItemFromSubMenu(MenuItem i_ItemToAdd)
        {
            r_SubMenuItems.Remove(i_ItemToAdd);
        }
    }
}
